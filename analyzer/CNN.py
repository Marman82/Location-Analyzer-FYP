...
transformer = transforms.Compose([
    ...
    transforms.Normalize([0.5,0.5,0.5],[0.5,0.5,0.5]) # 0-1 to [-1,1], formula x-mean/stand deviation
])
...
for epoch in range(num_epochs):
    ...
    print('Epoch: '+str(epoch)+' Train Loss: '+str(train_loss)+' Train Acc: '+str(train_acc)+' Test Acc: '+str(test_acc))
